...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxStoreJs = __webpack_require__(216);

	var _reduxStoreJs2 = _interopRequireDefault(_reduxStoreJs);

	var _configRoutesJs = __webpack_require__(278);

	var _configRoutesJs2 = _interopRequireDefault(_configRoutesJs);

	var _depsPhoenixWebStaticJsPhoenix = __webpack_require__(300);

	var _reduxAction_creatorsJs = __webpack_require__(280);

	var _reduxAction_creatorsJs2 = _interopRequireDefault(_reduxAction_creatorsJs);
	...
	channel.on("new:post", function (payload) {
	  console.log("There is a new post!");
	  _reduxStoreJs2['default'].dispatch(_reduxAction_creatorsJs2['default'].addPost(payload.post));
	});
	channel.on("remove:post", function (payload) {
	  console.log("Post has been removed");
	  _reduxStoreJs2['default'].dispatch(_reduxAction_creatorsJs2['default'].removePost(payload.post_id));
	});
	...
	window.onload = function () {
	  _reactRouter2['default'].run(_configRoutesJs2['default'], function (Root, state) {
	    _react2['default'].render(_react2['default'].createElement(
	      ...
	      { store: _reduxStoreJs2['default'] },
	      function () {
	        return _react2['default'].createElement(Root, _extends({}, state, { channel: channel }));
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsBindActionCreators = __webpack_require__(212);

	var _utilsBindActionCreators2 = _interopRequireDefault(_utilsBindActionCreators);

	var _utilsApplyMiddleware = __webpack_require__(213);

	var _utilsApplyMiddleware2 = _interopRequireDefault(_utilsApplyMiddleware);

	var _utilsCompose = __webpack_require__(214);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducersJs = __webpack_require__(218);

	var createStoreWithMiddleware = (0, _redux.applyMiddleware)(_reduxThunk2['default'])(_redux.createStore);

	var store = createStoreWithMiddleware(_reducersJs.posts);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashLangClone = __webpack_require__(219);

	var _lodashLangClone2 = _interopRequireDefault(_lodashLangClone);

	var _lodashCollectionFilter = __webpack_require__(251);
	...
	Reducers.posts = function posts(state, action) {
	  ...
	  switch (action.type) {
	    ...
	    case 'ADD_POST':
	      ...
	      var newState = (0, _lodashLangClone2['default'])(state, true);
	    ...
	    case 'REMOVE_POST':
	      ...
	      var newState = (0, _lodashCollectionFilter2['default'])(state, function (post) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bufferClone = __webpack_require__(246);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayFilter = __webpack_require__(252),
	    ...
	    baseFilter = __webpack_require__(275),
	    isArray = __webpack_require__(237);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isLength = __webpack_require__(234),
	    isObjectLike = __webpack_require__(230);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsPostsList = __webpack_require__(279);

	var _componentsPostsList2 = _interopRequireDefault(_componentsPostsList);

	var _reactRouter = __webpack_require__(157);

	exports['default'] = _react2['default'].createElement(_reactRouter.Route, { name: 'app', path: '/', handler: _componentsPostsList2['default'] });
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PostsList = _react2['default'].createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    _reduxStoreJs2['default'].dispatch(_reduxAction_creatorsJs2['default'].fetchPosts());
	  },
	  handleSubmit: function handleSubmit(e) {
	    ...
	    _axios2['default'].post('/api/posts', { post: post }).then(function (response) {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement('input', { type: 'text', className: 'form-control title' })
	        ),
	        _react2['default'].createElement(
	          'div',
	          { className: 'form-group' },
	          ...
	          _react2['default'].createElement('input', { type: 'text', className: 'form-control body' })
	        ),
	      ...
	      _react2['default'].createElement(
	        ...
	        this.props.posts.map(function (post) {
	          return _react2['default'].createElement(Post, { post: post, key: post.id, channel: self.props.channel });
	        })
	      )
	    );
	  }
	...
	var Post = _react2['default'].createClass({
	  ...
	  handleDelete: function handleDelete(e) {
	    ...
	    _axios2['default']['delete']('/api/posts/' + postId, {}).then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storeJs = __webpack_require__(216);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deprecatedMethod = __webpack_require__(285);
	  ...
	  return new Promise(function (resolve, reject) {
	    try {
	      ...
	      if (typeof window !== 'undefined') {
	        __webpack_require__(287)(resolve, reject, config);
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var urlIsSameOrigin = __webpack_require__(292);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3), __webpack_require__(295).setImmediate, (function() { return this; }()), __webpack_require__(296)(module)))
